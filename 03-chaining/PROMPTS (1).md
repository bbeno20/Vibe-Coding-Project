...
Problem: Expand removed the "AHA ACTION" badge from step 4, which I didn't ask it to change. Fix: sent a one-line follow-up ("Restore the AHA ACTION badge on step 4. Don't change anything else") and it was restored.
